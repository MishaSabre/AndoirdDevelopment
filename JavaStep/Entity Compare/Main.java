...
/**
 * «а основу была вз€та модель из любой RPG игры, где есть классы, за которые можно играть
 *
...
class Warrior extends Entity{
    ...
    public String toString(){
        return "Ёто воин, его оружие - " + this.weapon + ", его здоровье " + this.health +", его брон€ " + this.armor;
    }
}
...
class Archer extends Entity{
    ...
    @Override
    public String toString(){
        return "Ёто лучник, его оружие - " + this.weapon + ", его здоровье " + this.health;
    }
}
...
class Wizard extends Entity{
    ...
    @Override
    public String toString(){
        return "Ёто маг, его оружие - " + this.weapon + ", его здоровье " + this.health + ", запас магического щита "
                + this.magicShield;
    }
}
...
public class Main {
    ...
    public static void main(String[] args) {
        /*–ешил продемонстировать сравнени€ и сортировку только дл€ воина, так как остальные классы сделаны очень похоже
